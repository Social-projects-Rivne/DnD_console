...
public:
	...
	static json fLogin(std::string username, std::string password);
	static json fRegistration(std::string username, std::string email, std::string password, std::string repeat_password);
